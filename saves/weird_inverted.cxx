...
/* Quick Use
glslc shaders/shader.vert -o shaders/vert.spv && glslc shaders/shader.frag -o shaders/frag.spv && g++ -c -std=c++17 -DNDEBUG -O3 src/*.cxx -Iinclude && g++ *.o -o bin/main -Llib -lglfw -lvulkan -ldl -lpthread -lX11 -lXxf86vm -lXrandr -lXi && ./bin/main
*/
...
private:
    ...
    void createSphere(float radius, int segments, std::vector<Vertex>& vertices, std::vector<unsigned int>& indices) {
    ...
    void loadModel() {
        createSphere(10, 2000, vertices, indices);
